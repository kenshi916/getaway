...
import {loadCityPack,buildCity} from './city.js?v=32';
import {loadVehiclePack,makeVehicle,animateVehicle,vehicleReady} from './vehicles.js?v=32';
import {CARS,PAINTS,createCar} from './driving.mjs?v=32';
const VIEWS={
