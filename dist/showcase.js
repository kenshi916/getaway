...
import {loadCityPack,buildCity} from './city.js?v=37';
import {loadVehiclePack,makeVehicle,animateVehicle,vehicleReady} from './vehicles.js?v=37';
import {CARS,PAINTS,createCar} from './driving.mjs?v=37';
const VIEWS={
