...
import {loadCityPack,buildCity} from './city.js?v=21';
import {loadVehiclePack,makeVehicle,animateVehicle} from './vehicles.js?v=21';
import {CARS,PAINTS,createCar} from './driving.mjs?v=21';
const VIEWS={
