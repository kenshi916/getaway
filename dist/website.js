import {connectFooter} from './site-config.js?v=34';
connectFooter();
let showcase;
function start(){showcase??=import('./showcase.js?v=34').then(m=>m.startShowcase()).catch(error=>{console.error(error);const note=document.getElementById('cityLoading');if(note)note.innerHTML='EXPLORE THE CITY IN-GAME<span>Open GETAWAY to see the full map</span>';});}
