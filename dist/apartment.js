...
import {HOME_SPAWN,HOME_SPOTS,HOME_BOUNDS,homeRoom} from './home-layout.mjs?v=20';
export {HOME_SPAWN,HOME_SPOTS} from './home-layout.mjs?v=20';
...
export function buildApartment(templates,position=HOME_SPAWN,life={}){
 ...
 function resize(width,height){viewport={width,height};camera.aspect=width/height;camera.clearViewOffset();camera.fov=44;camera.updateProjectionMatrix();if(viewMode==='room'){if(width<=650)camera.setViewOffset(width,height,0,-height*.16,width,height);positionRoomCamera(1);return;}
